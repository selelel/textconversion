...
const Input = ({addConvert}) => {
  ...
  return (
      <div className="lg:w-[30rem] sm:w-[30rem] m-1 mx-auto">
        ...
        <textarea className="text-2xl bg-white/5 backdrop-blur-sm rounded-2xl w-full h-[20rem] border-4 border-cos-dark_purple/50 p-3 resize-none m-2 mb-4  duration-500 ease-out text-black hover:border-cos-onHover hover:scale-105" 
        value={value} 
